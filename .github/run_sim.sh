...
sleep 1
$GITHUB_WORKSPACE/build/examples/trading_system/application/app_trading_system "" > $GITHUB_WORKSPACE/app_trading_system.log 2>&1 &
sleep 1
$GITHUB_WORKSPACE/build/examples/trading_system/application/sim_client_a "" "0" "127.0.0.1" "8081" "tcp" "client" "clientA" "100" > $GITHUB_WORKSPACE/sim_client_a.log 2>&1 &
sleep 15
